...
const grass2 = Rngon.texture_rgba({
	...
	"channels":"rgba:5+5+5+1",
	"encoding":"base64",
	"pixels":""
});
...
const lamp1 = Rngon.texture_rgba({
	...
	"channels":"rgba:5+5+5+1",
	"encoding":"base64",
	"pixels":""
});
...
export const sample_scene = (frameCount)=>
{
    ...
    // Construct the ground tile mesh.
    {
        ...
        for (let y = 0; y < numTilesY; y++)
        {
            ...
            startX += ((groundTileWidth / 2) * ((((y + 1) % 2) == 0)? -1 : 1));
